...
Once a geometric configuration is defined and an analysis is run, then the results window appears. An example of what this results window may look like is shown in Figure 4. 
